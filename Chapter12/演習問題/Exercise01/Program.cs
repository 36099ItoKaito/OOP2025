...
namespace Exercise01 {
    internal class Program {
        static void Main(string[] args) {
            ...
            //問題12.1.3
            var empdata = Deserialize_f("employee.json");
        ...
        static string Serialize(Employee emp) {
            ...
            //    PropertyNamingPolicy = JsonSerializer.Camelcase,
            //};
        ...
        static void Serialize(string filePath, IEnumerable<Employee> employees) {
            var options = new JsonSerializerOptions {
                PropertyNamingPolicy = JsonNamingPolicy.CamelCase,
                WriteIndented = true,
                Encoder = JavaScriptEncoder.Create(UnicodeRanges.All)  // 日本語をそのまま出力
            };
        ...
        static Employee[] Deserialize_f(string filePath) {
            ...
            //var options = new JsonSerializerOptions {
            //    PropertyNamingPolicy = JsonNamingPolicy.CamelCase,
            //    Encoder = JsonScripEncoder.Create(UnicodeRange.All),
            //    WriteIndented = true
            //};
